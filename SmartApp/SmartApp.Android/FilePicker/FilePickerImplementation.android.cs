...
using SmartApp.FilePicker.Abstractions;
using System;
        ...
        private Task<FileData> PickFileAsync(string[] allowedTypes, string action)
        {
            ...
            try
            {
                ...
                handler = (s, uri) =>
                {
                    ...
                    var cursor = Application.Context.ContentResolver.Query(uri, new string[] { DocumentsContract.Document.ColumnDisplayName }, null, null);
